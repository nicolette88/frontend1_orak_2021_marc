...
// amikor az user rákattint a menu gombra
...
// amikor az user rákattint a close menu gombra
...
// amikor az user átmeretezi a böngésző ablakot:
window.addEventListener('resize', function () {
  // megvizsgáljuk, hogy nyitva van-e a menü
  if (document.querySelector('body').classList.contains('js-menu-open')) {
    if (window.innerWidth >= 650) {
      // ha a böngésző szélessége 650 fölé megy és nyitva van a menü, akkor a javascript automatikusan rákattint helyettünk a close gombra
